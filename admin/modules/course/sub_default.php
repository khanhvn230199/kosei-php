...
function default_default()
{
    ...
    $clsDataGrid->setTitle($core->getLang("Khóa học"));
    ...
    $clsDataGrid->addColumnUrl($pkeyTable, "Bài test", "width='3%' align='center' nowrap", "<a href='?mod=questions&cat_id=%1%&$returnExp' class='abutton1'>Quản lý bài test đầu vào &raquo;</a>");
...
function default_add()
{
    ...
    $clsForm->setTitle($core->getLang("Khóa học"));
