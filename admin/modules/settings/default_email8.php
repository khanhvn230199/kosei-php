...
function default_email8(){
	...
	//################### CHANGE BELOW CODE ###################
	$mail_advisory_file = DIR_CONFIGS."/".$lang_code."_mail_nhachoc.txt";
	...
	$clsForm->addInputSelect("mail_configs[mail_nhachoc]", $mail_configs['mail_nhachoc'], "Label", $arrYesNoOptions, 0, "style='font-size:12px;'");
