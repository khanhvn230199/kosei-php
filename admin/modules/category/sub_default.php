...
function default_default()
{
    ...
    makeArrayListCategory(0, 0, MAX_LEVEL_CATEGORY, $arrOptionsCategory, "ctype=$ctype $cond_lang");
    if (is_array($arrCtypeOptions)) {
        unset($arrCtypeOptions[CTYPE_KH]);
    }
    $htmlOptionsCtype = makeHTMLOptions($arrCtypeOptions, $ctype);
    //init Grid
    ...
    $assign_list["arrOptionsCategory"] = $arrOptionsCategory;
...
function default_add()
{
    ...
    $clsForm->addInputSelect("parent_id", $parent_id_def, "ParentGroup", $arrOptionsCategory, 0, "style='font-size:12px'");
