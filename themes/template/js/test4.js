...
<div>
  ...
  <div class="test-result__table table-responsive">
    <table class="table table-bordered">
        <tr>
            <td colspan="2">得点区分別得点 Điểm thành phần</td>
            <td rowspan="2">
                <div>総合得点</div>
                <div>Tổng điểm</div>
            </td>
        ...
        <tr>
            <td>
                <div>言語知識（文字・語彙・文法）+ 読解</div>
                <div>Từ vựng + Ngữ pháp + Đọc hiểu</div>
            </td>
        ...
        <tr>
            <td>${vocab + grammar + reading}/120</td>
            <td>${listening}/60</td>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                ...
                <td>${vocab + grammar + reading}/60</td>
