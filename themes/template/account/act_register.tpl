...
<nav>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{'Register'|lang}</li>
        </ol>
    </div>
</nav>
<section class="mb-50">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <p>{'Thank_you_for_register_to'|lang} <a href=".md-login" data-toggle="modal">{'Sign_in'|lang}</a> {'To_manage_your_account'|lang}.</p>
                            </div>
                            {else}
                            <div class="col-md-6 order-md-1">
                                <form method="POST" id="fRegister" name="fRegister">
                                    ...
                                    <div>
                                        <a class="text-primary text-uppercase" href=".md-login" data-toggle="modal">{'Login'|lang}</a>
