...
class Securimage {
  ...
  function generateWAV($letters)
  {
	...
	function showFormInput() {
		return "<input TYPE=text NAME='$this->name' MAXLENGTH='$this->code_length' />";
	}
	
	function showFormImage() {
		return "<img src='securimage_show.php?sid=".$this->sid."&&id=".md5(uniqid(time()))."'>";
	}
