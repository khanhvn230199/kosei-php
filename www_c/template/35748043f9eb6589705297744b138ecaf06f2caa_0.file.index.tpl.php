<?php
/* Smarty version 3.1.32, created on 2022-04-07 09:52:01
  from '/var/www/koseionline.vn/data/www/koseionline.vn/themes/template/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_624e51d1508a59_82266691',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35748043f9eb6589705297744b138ecaf06f2caa' => 
    array (
      0 => '/var/www/koseionline.vn/data/www/koseionline.vn/themes/template/index.tpl',
      1 => 1649299891,
      2 => 'file',
    ),
  ),
...
function content_624e51d1508a59_82266691 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">
...
>
  <?php if ($_smarty_tpl->tpl_vars['mod']->value == "trialtest" || ($_smarty_tpl->tpl_vars['mod']->value == 'account' && $_smarty_tpl->tpl_vars['act']->value == 'history')) {?>
    ...
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['URL_JS']->value;?>
/test4.js?v=1.2"><?php echo '</script'; ?>
>
    <!-- End -->
    <?php } else { ?>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['URL_JS']->value;?>
/test3.js?v=1.2"><?php echo '</script'; ?>
>
    <?php }?>
  ...
  <?php } else { ?>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['URL_JS']->value;?>
/test.js?v=1.2"><?php echo '</script'; ?>
>
  <?php }?>
  <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['URL_JS']->value;?>
/publish.js"><?php echo '</script'; ?>
>
