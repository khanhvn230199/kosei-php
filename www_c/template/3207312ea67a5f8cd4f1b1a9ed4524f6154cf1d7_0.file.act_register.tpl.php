<?php
/* Smarty version 3.1.32, created on 2023-05-31 19:18:41
  from '/var/www/koseionline/data/www/koseionline.vn/themes/template/trialtest/act_register.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_64773b21a78170_81298102',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3207312ea67a5f8cd4f1b1a9ed4524f6154cf1d7' => 
    array (
      0 => '/var/www/koseionline/data/www/koseionline.vn/themes/template/trialtest/act_register.tpl',
      1 => 1685527691,
      2 => 'file',
    ),
  ),
...
function content_64773b21a78170_81298102 (Smarty_Internal_Template $_smarty_tpl) {
...
" method="POST" id="fRegister" name="fRegister">
                        <h2 class="text-700 text-20 text-center text-uppercase"><?php echo smarty_modifier_lang('Trial_test_register');?>
</h2>
                        <div class="form-group">
                            <input class="form-control" type="text" name="fullname" placeholder="Họ &amp; tên" value="<?php echo $_smarty_tpl->tpl_vars['core']->value->_USER['fullname'];?>
" disabled>
                        </div>
                        <div class="form-group">
                            <input class="form-control" type="tel" name="mobile" placeholder="Số điện thoại" value="<?php echo $_smarty_tpl->tpl_vars['core']->value->_USER['mobile'];?>
" disabled>
                        </div>
                        <div class="form-group">
